...
enum MPIDataType {
  ...
  MPIDataType_TF_MPI_FLOAT16 = 6,
  MPIDataType_TF_MPI_FLOAT32 = 7,
  MPIDataType_TF_MPI_FLOAT64 = 8,
  MPIDataType_TF_MPI_BOOL = 9,
...
struct MPIRequestListBuilder {
  ...
  explicit MPIRequestListBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
